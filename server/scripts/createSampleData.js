...
const createSampleData = async () => {
    try {
        ...
        // Create sample workers (Employers) - some pending, some approved
        const sampleWorkers = [
            {
        ...
        // Create sample employers (NhaTuyenDung) - some pending, some approved
        ...
        for (const employerData of sampleEmployers) {
